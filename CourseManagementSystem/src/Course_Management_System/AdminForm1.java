...
public class AdminForm1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(266, 85, 153, 185));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 204, 204));
        jLabel1.setText("Students:");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(284, 35, -1, -1));

        jSeparator1.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jSeparator1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 204, 204), 2));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 30, -1, 250));

        jTextField1.setBackground(new java.awt.Color(0, 204, 204));
        jTextField1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 72, 99, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(145, 135, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            if(jTextField1.getText().trim().equals("")){
                JOptionPane.showMessageDialog(AdminForm1.this,"TextField Is Empty");
            }
            else{
            ...
            for(int i = 0;i < arrayCourse.size();i++){
                if(arrayCourse.get(i).CourseName.equals(jTextField1.getText().trim().toLowerCase())){
                    ...
                    Vector<Student> arrayStudents = new Vector();
                   arrayStudents = a.getStudents();
                   DefaultListModel lm = new DefaultListModel();
                   for(int j = 0;j < arrayStudents.size();j++){
                       lm.addElement(arrayStudents.get(j).ID);
                   }
                   jList1.setModel(lm);
                }
            }
            ...
            JOptionPane.showMessageDialog(AdminForm1.this, e.getMessage());
        } 
